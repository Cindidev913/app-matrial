            ...
            <div class="col-sm-6 col-xl-3">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0">{{ $jumlah_barang }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0">{{ $jumlah_supplier }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        <p class="mb-2">SALE</p>
                        <h6 class="mb-0">{{ $jumlah_penjualan }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Paid</td>
                            <td>
                                <a class="btn btn-sm btn-primary" href="/barang">Detail</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <div class="bg-secondary rounded-top p-4">
            <div class="row">
                ...
                <div class="col-6 col-sm-6 text-center text-sm-end">
                    ...
                    Distribut Company
                    <a href="" target="_blank">Follex Corporation</a>
                </div>
            </div>
        </div>
    </div>
